...
class AppText {
  ...
  // Scale
  static const double displayLg = 32; // 700 / 1.1
  static const double displayMd = 24; // 700 / 1.2
  static const double displaySm = 18; // 600 / 1.3
  static const double bodyLg    = 16; // 500 / 1.5
  static const double bodyMd    = 15; // 500 / 1.5
  static const double bodySm    = 14; // 400 / 1.5
  static const double caption   = 13; // 500 / 1.4
  static const double label     = 12; // 500 / 1.3
  static const double amountLg  = 48; // 700 / 1.1
  static const double amountMd  = 28; // 700 / 1.2
}
